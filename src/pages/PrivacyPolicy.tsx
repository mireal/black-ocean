          ...
          >
            ...
            <Typography variant="subtitle1" color="primary.contrastText">
              <Box>
                ...
                Data, for what purpose we process your Personal Data, whether
                you are required to provide us with certain information, how
                long we will store your Personal Data whether there are other
                recipients of your Personal Data, whether we intend to transfer
                your Personal Data to another country.
              </Box>
              <Box mt="5px">
                In principle, we will only use your Personal Data in accordance
                with the applicable data protection laws, in particular the
                Czech Republic`s Data Processing Act implementing the GDPR has
                been introduced as Act. No. 110/2019 Coll. (“DPA”), the EU's
                General Data Protection Regulation (GDPR), and only as described
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                info@oceanperform.com if you have any questions, comments or
                wish to exercise your rights under applicable data protection
                law.
              </Typography>
            </Stack>
            ...
            <Stack gap="20px">
              ...
              <Stack gap="5px">
                <Typography variant="subtitle1" color="primary.contrastText">
                  ...
                  <Box>
                    Furthermore, you can revoke consent, in principle with
                  ...
                  <Box>
                    ...
                    disclosure of your Personal Data, it may impact our ability
                    to proceed with your transactions, agreements, or
                    interactions with us. Prior to you exercising your choice to
                    withdraw your consent, we will inform you of the
                    consequences of the withdrawal of your consent. Please note
                    that your withdrawal of consent will not prevent us from
                    exercising our legal rights (including any remedies) or
            ...
            <Stack gap="20px">
              ...
              <Stack gap="5px">
                <Typography variant="subtitle1" color="primary.contrastText">
                  ...
                  OPDP, so please contact us in the first instance.
                </Typography>
              </Stack>
            </Stack>
              ...
              <Stack gap="5px">
                <Typography variant="subtitle1" color="primary.contrastText">
                  ...
                  >
                    ...
                    <li>
                      and of course, data that is automatically collected.
                    </li>
                  </ul>
                </Typography>
              </Stack>
                ...
                <Typography variant="subtitle1" color="primary.contrastText">
                  ...
                  >
                    ...
                    <li>
                      ...
                      from you and other details of products and services you
                      have ordered or commissioned from us.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      preferences in receiving marketing from us and any third
                      parties made known to you and your communication
                      preferences.
                    </li>
                    <li>
                  ...
                  <Box>
                    Data collected is linked and if we have already collected
                    some of your data, we will only ask you for the remaining
                    data that is necessary to carry out the service contracted
                    for.
                  </Box>
                </Typography>
              </Stack>
            ...
            <Stack gap="5px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                If you contact us, we process the following data from you for
                the purpose of processing and handling your enquiry: Name,
                contact details -if provided by you- and your message. The legal
                basis of the data processing is our obligation to fulfill the
                contract and/or to fulfill our pre-contractual obligations
                and/or our legitimate interest in processing your inquiry.
              </Typography>
            </Stack>
            ...
            <Stack gap="5px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                Personal Data will be collected, processed, or used in
                connection with the services offered. This is always done in
                compliance with the provisions of the DPA and GDPR. Insofar as
                we use your Personal Data for a purpose that requires your
                consent according to the legal provisions, we will always ask
            ...
            <Stack gap="5px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                as organization of our operations, financial accounting,
                payment, and compliance with legal obligations, such as
                archiving. In this regard, we process the same data that we
                process in the course of providing our contractual services (see
                above).
              </Typography>

              <Typography variant="subtitle1" color="primary.contrastText">
                The processing bases are contracts and our legitimate interest
                and in individual cases your consent. The purpose and our
                interest in the processing lies in the administration, financial
                accounting, office organization, archiving of data, i.e., tasks
                that serve the maintenance of our business activities,
                performance of our tasks and provision of our services.
              </Typography>
            </Stack>
            ...
            <Stack gap="5px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                collects a series of general data and information with each
                visit and this data is temporarily stored in log file. A log
                file is created in the course of an automatic protocol of the
                processing computer system. The following can be recorded: host
                name of the accessing end device, IP address, Date and time of
                the server request, Time zone difference to Greenwich Mean Time
                (GMT).
              </Typography>
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                session is necessary for this. The legal basis for this
            ...
            <Stack gap="5px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                please refer to our Cookie Policy. The legal basis for the use
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                No special categories of data are processed at Black ocean
                s.r.o.
              </Typography>
            </Stack>
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                this data, we will usually have to refuse to conclude the
                contract or will no longer be able to perform an existing
                contract and may have to terminate it.
              </Typography>
            </Stack>
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                access, modification, or distribution of your data by
                unauthorized persons. However, and despite regular checks,
                complete protection against all dangers is not possible. Our
                website uses the industry standard SSL (Secure Sockets Layer)
                for encryption. This ensures the confidentiality of your
                personal information over the Internet. You can tell whether
                encrypted transmission is taking place by the closed key/lock
                symbol in your browser display.
              </Typography>
            </Stack>
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                Your data will be stored by us for as long as it is needed for
                the respective purposes underlying the processing. Beyond that,
                we only store data insofar as we are legally obligated to do so,
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                <Stack gap="5px">
                  ...
                  <Box>
                    ...
                    third-party providers on the basis of our legitimate
                    interests in order to integrate their content and services
                    (hereinafter uniformly referred to as "content"). This
                    always requires that the third-party providers of this
                    content are aware of the IP address of the user, as without
                    the IP address they would not be able to send the content to
                    their browser. The IP address is therefore necessary for the
                    display of this content. We endeavor to only use content
                    whose respective providers only use the IP address to
                    deliver the content.
                  </Box>
                </Stack>
              </Typography>
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                <Stack gap="5px">
                  ...
                  <Box>
                    You may give us your consent in a number of ways including
                    by selecting a box on a form where we seek your permission
                    to send you marketing information, or sometimes your consent
                    is implied from your interactions or contractual
                    relationship with us. Where your consent is implied, it is
                    on the basis that you would have a reasonable expectation of
                    receiving a marketing communication based on your
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                <Stack gap="5px">
                  <Box>
                    This privacy and cookie policy is valid as of Monday, 21st
                    of August 2023. It is the current and valid version of our
                    privacy policy. However, we point out that from time to time
                    due to actual or legal changes a revision to this privacy
                    and cookie policy may be necessary.
                  </Box>
                  <Box>
                    If you have any data protection questions, please feel free
                    to contact us using the details provided above.
                  </Box>
                </Stack>
              </Typography>
            </Stack>
