        ...
        >
          ...
          >
            ...
            <Typography variant="subtitle1" color="primary.contrastText">
              ...
              <Box mt="5px">
                With this Cookie Policy, we would like to inform you, the user
                of our website, about the use of cookies or similar storage
                technologies (hereinafter "cookies").
              </Box>
              <Box mt="5px">
                We act as the Data controller in accordance with the Czech
                Republic`s Act No. 480/2004 Coll., on Certain Information
                Society Services (“ECA”) and the EU`s Privacy and Electronic
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                <Stack gap="5px">
                  <Box>
                    ...
                    ("first party cookie") or another website to which the
                    cookie belongs ("third party cookie").
                  </Box>
                  <Box>
                    ...
                    Information only takes place if you give us your consent or
                    if the storage is absolutely necessary in order to be able
                    to use our website.
                  </Box>
                </Stack>
              </Typography>
                ...
                <Typography variant="subtitle1" color="primary.contrastText">
                  ...
                  >
                    ...
                    <li>
                      ...
                      registered with your information on our website for
                      business and technical purposes.
                    </li>
                  </ul>
                  <Box>
                    Some of the cookies used on our websites are set by us,
                    others are set by third parties on our behalf. The use of
                    third-party cookies enables tailored advertising, meaning
                    you may see ads for Insulation Point.
                  </Box>
                  <ul
                    style={{
                      listStyleType: "disc",
                  ...
                  >
                    ...
                    <li>
                      Performance and analytics cookies: these cookies allow us
                      to track visits and traffic sources to measure and improve
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                Of course, you can also use our website entirely without
                cookies. You can configure the use of cookies in your browser
                settings by following the relevant link{" "}
                <Link
                ...
                at any time or deactivate them completely. However, this may
                lead to restrictions in the functions or user-friendliness of
                our offer.
              </Typography>
            </Stack>
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                for a number of reasons, such as to reflect a change in the law
                or to accommodate a change in our business practices and the way
                we use cookies. We recommend that you check here periodically
            ...
            <Stack gap="20px">
              ...
              <Typography variant="subtitle1" color="primary.contrastText">
                ...
                wish to exercise your rights under applicable laws, please
                contact us.
              </Typography>
            </Stack>
