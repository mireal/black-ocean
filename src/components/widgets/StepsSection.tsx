        ...
        <>
            ...
            >
                ...
                <Grid2 container columns={{ mobileP: 1, tablet: 3 }} rowGap='40px'>
                    {/* big paragraph */}
                    <Grid2 offset={{ mobileP: 0, desktopS: 1 }} size={{ mobileP: 1, tablet: 3, desktopS: 2 }}>
                        <Typography
                            variant="body1"
                            color="primary.light"
                            ...
                            textTransform="uppercase"
                        >
                            Over the long experience of working with clients, we have built our own scheme of
                            work. Our cooperation scheme is extremely effective. We are able to provide you with
                    ...
                    <Grid2 size={1}>
                        <StepCard
                            content={{
                                ...
                                paragraph:
                                    `If you are interested, you can contact us to discuss the tasks of your business.
                    ...
                    <Grid2 size={1}>
                        <StepCard
                            content={{
                                ...
                                paragraph:
                                    `At the second stage, our team processes your request and selects the best solutions for you. 
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <img src='./src/assets/images/steps-small.png' style={{ width: '100%' }} />
                    </Box>
                    ...
                    <Box sx={{
                        ...
                        <img src='./src/assets/images/steps-big.png' style={{width:'100%'}}/>
                    </Box>
                </Box>
            </Box>
        </>
