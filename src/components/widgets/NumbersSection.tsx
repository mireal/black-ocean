    ...
    const content: NumberCardContent[] = [
        {
            ...
            paragraph: 'Proven expertise across diverse industries, ensuring exceptional outcomes.'
        },
        {
            number: '99%',
            title: 'Success Rate',
            paragraph: 'Trusted by clients worldwide for reliable and effective solution'
        },
        {
            number: '30+',
            title: 'Traffic & Software Projects',
            paragraph: 'Fueling creativity and dedication behind every successful project.'
        },
        {
            number: '20+',
            title: 'Specialists',
            paragraph: 'A highly skilled team dedicated to solving complex challenges.'
        },
        {
            number: '5',
            title: 'Ongoing Projects',
            paragraph: 'Continuously driving innovation and delivering value to our clients.'
        },
        {
            number: '1000+',
            title: 'Cups of Coffe',
                ...
                <Grid2 container columns={3}>
                    <Grid2 offset={{ mobileP: 0, desktopS: 1 }} size={{ mobileP: 3, desktopS: 2 }}>
                        <Typography
                            ...
                            textTransform="uppercase"
                        >
                            When you work with us, you’re choosing a team that values excellence in every detail, from project completion to ongoing support.
                        </Typography>
