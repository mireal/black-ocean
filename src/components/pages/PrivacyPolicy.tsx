            ...
            <Box paddingX={{ mobileP: '10px', mobileL: '16px', tablet: '20px', desktopS: '40px' }}>
                ...
                <Stack spacing='30px' paddingTop='40px' paddingBottom={{ mobileP: '40px', tablet: '60px', desktopS: '80px' }}>
                    ...
                    <Typography variant="subtitle1" color="primary.contrastText">
                        ...
                        <Box mt='5px'>
                            In principle, we will only use your Personal Data in accordance with the applicable data protection laws, in particular the Czech Republic`s Data Processing Act implementing the GDPR has been introduced as Act. No. 110/2019 Coll. (“DPA”), the EU's General Data Protection Regulation (GDPR), and only as described in this Privacy Policy.
                        </Box>
                    </Typography>
                    ...
                    <Stack gap='20px'>
                        ...
                        <Typography variant="subtitle1" color="primary.contrastText">
                            Unless otherwise stated, Black ocean s.r.o. of Michelska 966/74, Michle, 141 00 Prague, Czech Republic is the controller for all processing of Personal Data. You can contact us using info@oceanperform.com if you have any questions, comments or wish to exercise your rights under applicable data protection law.
                        </Typography>
                    </Stack>
                    ...
                    <Stack gap='20px'>
                        ...
                        <Stack gap='5px'>
                            <Typography variant="subtitle1" color="primary.contrastText">
                                ...
                                <Box>Furthermore, you can revoke consent, in principle with effect for the future.</Box>
                                <Box>Furthermore, you have the right to lodge a complaint with a data protection supervisory authority. We would, however, appreciate the chance to deal with your concerns before you approach a data protection supervisory authority.</Box>
                                <Box>Finally, you also have a right to object. This applies, on grounds relating to data processing on the basis of our legitimate interest and also to profiling. If you object, we will no longer process your Personal Data unless we can demonstrate compelling legitimate reasons for the processing which override your interests, rights and freedoms, or the processing serves to assert, exercise or defend legal claims.</Box>
                                <Box>You may also withdraw your consent and request us to stop using and/or disclosing your Personal Data for any or all of the Purposes by submitting your request to us in writing. Should you withdraw your consent to the collection, use or disclosure of your Personal Data, it may impact our ability to proceed with your transactions, agreements, or interactions with us. Prior to you exercising your choice to withdraw your consent, we will inform you of the consequences of the withdrawal of your consent. Please note that your withdrawal of consent will not prevent us from exercising our legal rights (including any remedies) or undertaking any steps as we may be entitled to at law.</Box>
                            </Typography>
                        </Stack>
                    </Stack>
                    ...
                    <Stack gap='20px'>
                        ...
                        <Stack gap='5px'>
                            <Typography variant="subtitle1" color="primary.contrastText">
                                We may collect personal information from you in the course of our business, your use of our Services. <br /> In general the personal data we collect is limited to the following:
                                <ul style={{ listStyleType: 'disc', paddingLeft: '25px', margin: 0 }}>
                                    <li>
                    ...
                    <Stack gap='5px'>
                        <Typography variant="h4" fontSize='18px' color="primary.main" fontWeight='bold'>
                            Contacting us
                        </Typography>
                    ...
                    <Stack gap='5px'>
                        ...
                        <Typography variant="subtitle1" color="primary.contrastText">
                            We process data in the context of administrative tasks as well as organization of our operations, financial accounting, payment, and compliance with legal obligations, such as archiving. In this regard, we process the same data that we process in the course of providing our contractual services (see above).
                        </Typography>

                        <Typography variant="subtitle1" color="primary.contrastText">
                            The processing bases are contracts and our legitimate interest and in individual cases your consent. The purpose and our interest in the processing lies in the administration, financial accounting, office organization, archiving of data, i.e., tasks that serve the maintenance of our business activities, performance of our tasks and provision of our services.
                        </Typography>
                    </Stack>
                    ...
                    <Stack gap='20px'>
                        ...
                        <Typography variant="subtitle1" color="primary.contrastText">
                            Automated decision making within the meaning of the DPA and GDPR is not used at Black ocean s.r.o.
                        </Typography>
                    </Stack>
                        ...
                        <Stack gap='5px'>
                            <Typography variant="subtitle1" color="primary.contrastText">
                                ...
                                <ul style={{ listStyleType: 'disc', paddingLeft: '25px', margin: 0 }}>
                                    ...
                                    <li>if the disclosure is necessary for the fulfillment of contractual obligations;</li>
                                    <li>if we are legally obligated to disclose the data;</li>
                                    <li>if the disclosure of the data is in the public interest;</li>
                                    <li>if the disclosure of the data is necessary for the protection of our legitimate interests or the legitimate interests of a third party unless your interests in the protection of your data override these interests.</li>
                                </ul>
                            </Typography>
                        </Stack>
                    </Stack>
                    ...
                    <Stack gap='20px'>
                        ...
                        <Typography variant="subtitle1" color="primary.contrastText">
                            <Stack gap='5px'>
                                <Box>Third-party providers may also use so-called pixel tags (invisible graphics, also known as "web beacons") for statistical or marketing purposes. The "pixel tags" can be used to evaluate information such as visitor traffic on the pages of this website. The pseudonymous information may also be stored in cookies on the user's device and may contain, among other things, technical information about the browser and operating system, referring websites, time of visit and other information about the use of our website, as well as being linked to such information from other sources.</Box>
                                <Box>Within our website, we use content or service offers of third-party providers on the basis of our legitimate interests in order to integrate their content and services (hereinafter uniformly referred to as "content"). This always requires that the third-party providers of this content are aware of the IP address of the user, as without the IP address they would not be able to send the content to their browser. The IP address is therefore necessary for the display of this content. We endeavor to only use content whose respective providers only use the IP address to deliver the content.</Box>
                            </Stack>
                        </Typography>
                    </Stack>
                    ...
                    <Stack gap='20px'>
                        ...
                        <Typography variant="subtitle1" color="primary.contrastText">
                            <Stack gap='5px'>
                                <Box>Insofar as you have also given us your separate consent to process your data for marketing and advertising purposes, we are entitled to contact you for these purposes via the communication channels you have given your consent to.</Box>
                                <Box>You may give us your consent in a number of ways including by selecting a box on a form where we seek your permission to send you marketing information, or sometimes your consent is implied from your interactions or contractual relationship with us. Where your consent is implied, it is on the basis that you would have a reasonable expectation of receiving a marketing communication based on your interactions or contractual relationship with us.</Box>
                                <Box>Direct Marketing generally takes the form of e-mail but may also include other less traditional or emerging channels. These forms of contact will be managed by us, or by our contracted service providers. Every directly addressed marketing sent or made by us or on our behalf will include a means by which you may unsubscribe or opt out.</Box>
                            </Stack>
                        </Typography>
                    </Stack>
                    ...
                    <Stack gap='20px'>
                        ...
                        <Typography variant="subtitle1" color="primary.contrastText">
                            <Stack gap='5px'>
                                <Box>This privacy and cookie policy is valid as of Monday, 21st of August 2023. It is the current and valid version of our privacy policy. However, we point out that from time to time due to actual or legal changes a revision to this privacy and cookie policy may be necessary.</Box>
                                <Box>If you have any data protection questions, please feel free to contact us using the details provided above.</Box>
                            </Stack>
                        </Typography>
                    </Stack>
